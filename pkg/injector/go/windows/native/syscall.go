...
func (e *SyscallGoShellcode) RenderInstanciationCode(data embed.FS) (string, error) {
	...
	return common.CommonRendering(data, "templates/go/injector/windows/native/local/go-shellcode-syscall/instanciation.go.tmpl", e)
}

func (e *SyscallGoShellcode) RenderFunctionCode(data embed.FS) (string, error) {

	return common.CommonRendering(data, "templates/go/injector/windows/native/local/go-shellcode-syscall/functions.go.tmpl", e)
}
